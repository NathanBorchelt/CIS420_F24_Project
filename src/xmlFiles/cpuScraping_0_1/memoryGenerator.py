...
ddr5_3200_Mem = ["64 GB PC5-38400 1x64GB 2Rank Memory", "384 GB PC5-38400 6x64GB 2Rank Memory", "768 GB PC5-38400 12x64GB 2Rank Memory"]
...
#stick specs DDR5 4800: https://harddiskdirect.com/p50312-b21-hpe-64gb-ddr5-4800mhz-pc5-38400-ecc-registered-cl40-288-pin-rdimm-1-1v-dual-rank-memory-module.html?campaign=686987897&adgrp=1315018196120914&device=c&adposition=&keyword=&utm_source=bing&utm_medium=cpc&utm_campaign=SMART%20SHOPPING%20-%2006/06/2023&utm_term=4585788126352397&utm_content=All%20Product%20Catalog
...
with open('../clusterdesign/hpe_pc5_memory.xml', 'w') as ddr5:
	...
	for memoryLine in ddr5_3200_Mem:
		memory = memoryLine.split()
		capacity = memory[0]
		memGeneration = memory[2].split('-')[0]
		memSpeed = memory[2].split('-')[1]
