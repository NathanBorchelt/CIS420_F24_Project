...
```
cd existing_repo
git remote add origin https://gitlab.hpc.mil/jonathan.thompson.22/afrl_cluster_design.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.hpc.mil/jonathan.thompson.22/afrl_cluster_design/-/settings/integrations)
